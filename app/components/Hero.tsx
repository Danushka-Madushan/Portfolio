...
export default function Hero() {
  return (
    <section className="container flex max-w-screen-2xl flex-col items-center justify-center space-y-6 pt-24 pb-4 text-center">
      <AvatarImage />
      <div className="flex flex-col gap-y-2">
        ...
        <h1 className="bg-gradient-to-br from-foreground from-30% via-foreground/90 to-foreground/70 bg-clip-text text-4xl leading-7 font-thin tracking-tight text-transparent">
