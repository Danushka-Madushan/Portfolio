...
export default function Hero() {
  return (
    <section className="container flex max-w-screen-2xl flex-col items-center justify-center space-y-6 pb-4 text-center">
      <AvatarImage />
      <div className="flex flex-col gap-y-2">
        <span className="text-4xl md:text-7xl font-bold tracking-tight">
          <span
            className={cn(
              "bg-clip-text text-transparent bg-linear-to-r from-blue-500 via-green-400 to-rose-300 ",
              pacifico.className,
            )}
          >
            Danushka Madushan.
        ...
        <p className="max-w-2xl leading-normal text-muted-foreground text-base mx-2 font-thin sm:text-xl sm:leading-8">
